...
$connector = new WindowsPrintConnector("SLK-TL320"); // Add connector for your printer here.
...
// try {
    ...
    // }
try{
	$dest = $_SERVER['DOCUMENT_ROOT'].'/aaaa_print/escpos/example/tmpimg/aysu-ruzgar.jpg';
